  ...
  return <>
    <Container className="pt-sm-5 d-flex overflow-auto flex-column">
      ...
      <Stack direction='horizontal' gap={3}>
        <Link to='/admin/financial/records' className='text-decoration-none fw-bold text-black' style={{borderBottom: location.pathname.endsWith('/financial/records') ? "#344CB7 5px solid": ""}}>Payment Records</Link>
        <Link to='/admin/financial/monthly-due' className='text-decoration-none fw-bold text-black' style={{borderBottom: location.pathname.endsWith('/financial/monthly-due') ? "#344CB7 5px solid": ""}}>Monthly Dues</Link>
      </Stack>
