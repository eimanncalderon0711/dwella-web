    ...
    <div className="p-4 rounded-3 m-auto" style={{ backgroundColor: "#F2F2F7", width: "90%"}}>
        ...
        <Row>
            <Col className="d-flex justify-content-between align-items-center">
                ...
                <div onClick={() => navigate({to: '/admin/edit-profile'})} className="bg-primary px-3 py-2 text-light d-flex gap-2 align-items-center rounded-3" style={{cursor:"pointer"}}>
        ...
        <Row className="d-flex flex-column">
            <Col className="d-flex justify-content-between flex-wrap gap-2">
                ...
                <div>
                    ...
                    <p className="fs-5 fw-bold">sheilamae@gmail.com</p>
